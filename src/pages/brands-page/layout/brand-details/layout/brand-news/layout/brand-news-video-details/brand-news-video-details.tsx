...
import { useGetBrandEventNewsVideoByIdQuery } from 'src/store/brandEvents/brand-events.api'

import styles from './index.module.scss'

export const BrandNewsVideoDetails: FC = () => {
	const { id, vidId } = useParams()
	const { data: videoDetails } = useGetBrandEventNewsVideoByIdQuery({
		brandEventId: id,
		videoId: vidId,
	})
